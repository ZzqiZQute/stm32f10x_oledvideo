...
//OLED控制用函数
#define OLED_DC_Clr()	GPIO_ResetBits(GPIOB,GPIO_Pin_2)
#define OLED_DC_Set()	GPIO_SetBits(GPIOB,GPIO_Pin_2)
#define OLED_RST_Clr()	GPIO_ResetBits(GPIOC,GPIO_Pin_7)
#define OLED_RST_Set()	GPIO_SetBits(GPIOC,GPIO_Pin_7)
#define OLED_CS_Clr()	GPIO_ResetBits(GPIOC,GPIO_Pin_8)
